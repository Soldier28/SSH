package com.mikey.youngvolunteer.models.dao.admin.impl;
...
public class AdminDaoImpl implements AdminDao {
    ...
    public SysAdminEntity findOneAdminy(SysAdminEntity sysAdminEntity) {
        return (SysAdminEntity) hibernateTemplate.find("from com.mikey.youngvolunteer.models.model.SysAdminEntity where adminId = ?0", sysAdminEntity.getAdminId()).get(0);
    }
