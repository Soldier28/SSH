package com.mikey.youngvolunteer.models.dao.volunteer.impl;
...
public class VolunteerDaoImpl implements VolunteerDao {
    ...
    public SysVolunteerEntity findOneSysVolunteery(SysVolunteerEntity sysVolunteerEntity) {
        return (SysVolunteerEntity) hibernateTemplate.find("from com.mikey.youngvolunteer.models.model.SysVolunteerEntity where volunteerId = ?0", sysVolunteerEntity.getVolunteerId()).get(0);
    }
