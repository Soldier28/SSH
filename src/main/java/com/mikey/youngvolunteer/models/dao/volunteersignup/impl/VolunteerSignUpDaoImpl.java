package com.mikey.youngvolunteer.models.dao.volunteersignup.impl;
...
public class VolunteerSignUpDaoImpl implements VolunteerSignUpDao {
    ...
    public VolunteerSignUpEntity findOneVolunteerSignUpy(VolunteerSignUpEntity volunteerSignUpEntity) {
        return (VolunteerSignUpEntity) hibernateTemplate.find("from com.mikey.youngvolunteer.models.model.VolunteerSignUpEntity where signUpId = ?0", volunteerSignUpEntity.getSignUpId()).get(0);
    }
