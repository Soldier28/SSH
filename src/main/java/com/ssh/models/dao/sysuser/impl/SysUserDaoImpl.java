package com.ssh.models.dao.sysuser.impl;
...
public class SysUserDaoImpl implements SysUserDao {
    ...
    public SysUserEntity findOneSysUsery(SysUserEntity sysUserEntity) {
        return (SysUserEntity) hibernateTemplate.find("from com.mikey.SSH.models.model.SysUserEntity where userId = ?0", sysUserEntity.getUserId()).get(0);
    }
